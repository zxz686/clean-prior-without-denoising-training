...
def define_G(opt):
    ...
    # 自注意力机制的ResNet101
    # ----------------------------------------
    elif net_type == 'resnet101_sa':
        from models.network_resnet101_sa import ResNet101_SA as net
        netG = net()
        #print("成功初始化Resnet")
    # ----------------------------------------
    # SRResnet
    ...
    # SRResnet2
    # ----------------------------------------
    elif net_type == 'srresnet2':
        from models.network_srresnet2 import MSRResNet2 as net
        netG = net()
        print("成功初始化SRResnet2")
    # ----------------------------------------
    # mem
    # ----------------------------------------
    elif net_type == 'mem':
        from models.network_mem import Mem as net
        netG = net()
        print("成功初始化mem")
    ...
    # ----------------------------------------
        ...
        from models.network_catt import CAtt as net
        netG = net()
        print("成功初始化catt")
    # ----------------------------------------
    # others
    ...
    # ----------------------------------------
    if opt['is_train']:
        if net_type not in ['srresnet', 'srresnet2', 'mem', 'unet', 'catt'] :
            init_weights(netG,
